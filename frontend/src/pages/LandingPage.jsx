            ...
            <Grid cols={4} gap="md" colsMd={2} colsSm={1}>
              ...
              <GlassCardHover className="p-6 flex flex-col justify-between h-56">
                <FlexLayout justify="between" align="center">
                  ...
                  <Badge variant="secondary">ManagementMSP</Badge>
                </FlexLayout>
                <Stack spacing="xs">
                  <SectionTitle className="text-sm font-bold text-white">Management</SectionTitle>
          ...
          <RevealOnScroll>
            <Grid cols={4} gap="lg" colsMd={2} colsSm={1}>
              ...
              <GlowCard className="p-8 flex flex-col gap-2">
                ...
                <BodyText className="text-xs text-muted-foreground mt-1">Finance, Trustee, Audit, and Management.</BodyText>
              </GlowCard>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Sign In to Treasury Console">
        <form onSubmit={handleLoginSubmit} className="flex flex-col gap-4 mt-6">
          <p className="text-xs text-muted-foreground leading-relaxed">
            Sign in with your organization credentials to access the treasury dashboard.
          </p>
          
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-white/90 ml-1">Organization</label>
            <select 
              value={organization}
              onChange={(e) => setOrganization(e.target.value)}
              className="flex h-11 w-full rounded-md border border-white/10 bg-black/40 px-3 py-2 text-sm text-white transition-colors placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary disabled:cursor-not-allowed disabled:opacity-50"
            >
